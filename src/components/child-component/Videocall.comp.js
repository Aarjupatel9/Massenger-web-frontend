    ...
    <div className="chatsRecyclerView">
      ...
      <div className="container">
        <div className="card text-center">
          <div className="card-header">Vedio Call</div>
          <div className="card-body"><button className="btn btn-primary btn-lg">Start</button>
          </div>
        </div>
        <div className="card p-0 text-center">
          <div className="card-body "><button className="btn btn-primary btn-lg" onClick={()=>{goBack()}}>End</button>
          </div>
        </div>
      </div>
    </div>
